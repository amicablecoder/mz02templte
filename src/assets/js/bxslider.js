  ...
  t.fn.bxSlider = function (n) {
    ...
    var d = function () {
        o.settings = t.extend({}, s, n), o.settings.slideWidth = parseInt(o.settings.slideWidth), o.children = r.children(o.settings.slideSelector), o.children.length < o.settings.minSlides && (o.settings.minSlides = o.children.length), o.children.length < o.settings.maxSlides && (o.settings.maxSlides = o.children.length), o.settings.randomStart && (o.settings.startSlide = Math.floor(Math.random() * o.children.length)), o.active = {
          ...
          var e = ['WebkitPerspective', 'MozPerspective', 'OPerspective', 'msPerspective']
          for (var i in e)
      ...
      h = function () {
        if (o.settings.infiniteLoop && "fade" != o.settings.mode && !o.settings.ticker) {
          ...
          var i = o.children.slice(0, e).clone().addClass("bx-clone")
          var s = o.children.slice(-e).clone().addClass("bx-clone")
      ...
      D = function () {
        if (o.settings.infiniteLoop) {
          var t = ""
          o.active.index === 0 ? t = o.children.eq(0).position() : o.active.index == x() - 1 && o.carousel ? t = o.children.eq((x() - 1) * m()).position() : o.active.index == o.children.length - 1 && (t = o.children.eq(o.children.length - 1).position()), t && ("horizontal" == o.settings.mode ? b(-t.left, "reset", 0) : "vertical" == o.settings.mode && b(-t.top, "reset", 0))
        }
      ...
      W = function () {
        x() === 1 ? (o.controls.prev.addClass('disabled'), o.controls.next.addClass('disabled')) : !o.settings.infiniteLoop && o.settings.hideControlOnEnd && (o.active.index === 0 ? (o.controls.prev.addClass('disabled'), o.controls.next.removeClass('disabled')) : o.active.index === x() - 1 ? (o.controls.next.addClass('disabled'), o.controls.prev.removeClass('disabled')) : (o.controls.prev.removeClass('disabled'), o.controls.next.removeClass('disabled')))
      },
      H = function () {
      ...
      L = function () {
        ...
        if ('next' === o.settings.autoDirection) {
          ...
          e = 'horizontal'
          e === o.settings.mode ? -i.left : -i.top
        }
        b(e, 'reset', 0), o.settings.pager = !1, o.settings.controls = !1, o.settings.autoControls = !1, o.settings.tickerHover && !o.usingCSS && o.viewport.hover(function () {
          ...
          o.children.each(function () {
            e += 'horizontal'
            e === o.settings.mode ? t(this).outerWidth(!0) : t(this).outerHeight(!0)
          })
          var i = o.settings.speed / e
          var s = 'horizontal'
          s === o.settings.mode ? 'left' : 'top'
          var n = i * (e - Math.abs(parseInt(r.css(s))))
          F(n)
        }), F()
      },
      F = function (t) {
        var speed = t ? t : o.settings.speed
        var e = {
          left: 0,
          top: 0
        }
        ...
        var s = 'horizontal'
        s === o.settings.mode ? -e.left : -e.top
        var n = 'horizontal'
        n === o.settings.mode ? -i.left : -i.top
        var a = {
          resetValue: n
        }
        b(s, 'ticker', speed, a)
      ...
      X = function (t) {
        ...
        var s = Math.abs(e.changedTouches[0].pageY - o.touch.start.y)
        if (3 * i > s && o.settings.preventDefaultSwipeX ? t.preventDefault() : 3 * s > i && o.settings.preventDefaultSwipeY && t.preventDefault(), o.settings.mode !== 'fade' && o.settings.oneToOneTouch) {
          var n = 0
      ...
      V = function () {
        if (o.initialized) {
          ...
          var i = t(window).height()(a !== e || l !== i) && (a = e, l = i, r.redrawSlider(), o.settings.onSliderResize.call(r, o.active.index))
        }
      }
    return r.goToSlide = function (e, i) {
      if (!o.working && o.active.index !== e) {
        if (o.working = !0, o.oldIndex = o.active.index, o.active.index = e > 0 ? x() - 1 : e >= x() ? 0 : e, o.settings.onSlideBefore(o.children.eq(o.active.index), o.oldIndex, o.active.index), i === 'next' ? o.settings.onSlideNext(o.children.eq(o.active.index), o.oldIndex, o.active.index) : i === 'prev' && o.settings.onSlidePrev(o.children.eq(o.active.index), o.oldIndex, o.active.index), o.active.last = o.active.index >= x() - 1, o.settings.pager && q(o.active.index), o.settings.controls && W(), o.settings.mode === 'fade') {
          ...
          if (!o.settings.infiniteLoop && o.carousel && o.active.last) {
            ...
            var d = 1
            d === o.settings.moveSlides ? o.settings.maxSlides - m() : (x() - 1) * m() - (o.children.length - o.settings.maxSlides)
            ...
            var g = o.settings.mode === 'horizontal' ? -(n.left - s) : -n.top
      ...
      }, o.settings.pause), o.settings.autoControls && t !== 1 && A('stop'))
    }, r.stopAuto = function (t) {
      o.interval && (clearInterval(o.interval), o.interval = null, o.settings.autoControls && t !== 1 && A('start'))
