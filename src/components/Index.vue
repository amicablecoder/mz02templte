  ...
  <div>
    ...
    <!--div id="loader">
      <div class="loader-container">
        <img src="../assets/images/site.gif" alt="" class="loader-site">
      </div>
    </div-->
	   <div id="wrapper">
		     <div class="topbar">
                    ...
                    <div class="navbar navbar-default" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                                        ...
                                        <div class="ttmenu-content">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="box">
                                                        <ul>
                                                            ...
                                                            <li><a href="">Courses Filterable</a></li>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="box">
                                                    	<ul>
                                                            <li><a href="">Course Instructors</a></li>
                                                            <li><a href="">Community Forums</a></li>
                                                            <li><a href="">Login & Register</a></li>
                                                            <li><a href="">Edit Your Account</a></li>
                                                            <li><a href="">Happy Students</a></li>
                                                            <li><a href="">Friendly Asked Questions</a></li>
                                                        </ul>
                                                    </div><!-- end box -->
                                                </div><!-- end col -->
                                            </div><!-- end row -->
											...
											<div class="row">
                                                <div class="col-md-3 col-sm-6 nopadding">
													<img class="img-thumbnail" src="../assets/upload/service_01.png" alt="">
                                                </div>
                                                <div class="col-md-3 col-sm-6 nopadding">
													<img class="img-thumbnail" src="../assets/upload/service_02.png" alt="">
                                                </div>
                                                <div class="col-md-3 col-sm-6 nopadding">
													<img class="img-thumbnail" src="../assets/upload/service_03.png" alt="">
                                                </div>
                                                <div class="col-md-3 col-sm-6 nopadding">
													<img class="img-thumbnail" src="../assets/upload/service_04.png" alt="">
                                                </div>
                                            </div><!-- end row -->
                                        </div><!-- end ttmenu-content -->
                                        </li>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="box">
                                                        <ul>
                                                            ...
                                                            <li><a href="#">Shop Single Alt</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a class="btn btn-primary" href="#"><i class="fa fa-sign-in"></i> Register Now</a></li>
                            </ul>
                        </div><!--/.nav-collapse -->
                ...
                <div class="tp-banner">
                    <ul>
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../assets/upload/slider_new_01.jpg"  data-saveperformance="off"  data-title="Slide">
                            <img src="../assets/upload/slider_new_01.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <!-- MAIN IMAGE -->
                            ...
                            <div class="tp-caption tp-fade fadeout fullscreenvideo"
                                ...
                                poster='../assets/images/dummy.png' data-setup="{}">
                                <source src='../assets/upload/video.mp4' type='video/mp4' />
                                <source src='../assets/upload/video.webm' type='video/webm' />
                                <!-- source src='../assets/upload/video.ogv' type='video/ogg' /-->
                                </video>
                            </div>
                            <div class="tp-caption slider_layer_01 text-center lft tp-resizeme"
                                data-x="center"
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../assets/upload/slider_new_03.jpg"  data-saveperformance="off"  data-title="Slide">
                            <img src="../assets/upload/slider_new_03.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../assets/upload/slider_new_02.jpg"  data-saveperformance="off"  data-title="Slide">
                            <img src="../assets/upload/slider_new_02.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <div id="owl-featured" class="owl-custom">
                    <div class="owl-featured">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="../assets/upload/course_01.png" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                            <div class="shop-item-title clearfix">
                                <h4><a href="#">Learn Web Design & Development</a></h4>
                                <div class="shopmeta">
                    ...
                    <div class="owl-featured">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="../assets/upload/course_02.png" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                            <div class="shop-item-title clearfix">
                                <h4><a href="#">Graphic Design & Logo Mockups Course</a></h4>
                                <div class="shopmeta">
                    ...
                    <div class="owl-featured">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="../assets/upload/course_03.png" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                            <div class="shop-item-title clearfix">
                                <h4><a href="#">Social Media Network & Marketing</a></h4>
                                <div class="shopmeta">
                    ...
                    <div class="owl-featured">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="../assets/upload/course_04.png" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                            <div class="shop-item-title clearfix">
                                <h4><a href="">WordPress Blogging, Tumblr and Blogger</a></h4>
                                <div class="shopmeta">
                                    <span class="pull-left">98 Student</span>
                                    <div class="rating pull-right">
                                        <i class="fa fa-star"></i>
        ...
        <section class="section darkskin fullscreen paralbackground parallax" style="background-image:url('../assets/upload/parallax_01.jpg');" data-img-width="1627" data-img-height="868" data-diff="100">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="image-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <img src="../assets/upload/device_02.png" alt="" class="img-responsive">
                        </div>
                    </div><!-- end col -->
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="content-widget">
                            <div class="team-members row">
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="team">
                                        <img src="upload/team_01.jpg" alt="" class="img-responsive wow fadeInUp">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="team">
                                        <img src="../assets/upload/team_02.jpg" alt="" class="img-responsive wow fadeInUp">
                                        <div class="team-hover-content">
                                            <h5>Adam DEO</h5>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="team">
                                        <img src="../assets/upload/team_03.jpg" alt="" class="img-responsive wow fadeInUp">
                                        <div class="team-hover-content">
                                            <h5>Jenny Kennedy</h5>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="team">
                                        <img src="../assets/upload/team_04.jpg" alt="" class="img-responsive wow fadeInUp">
                                        <div class="team-hover-content">
                                            <h5>Jennifer DEO</h5>
        ...
        <section class="section fullscreen paralbackground parallax" style="background-image:url('../assets/upload/parallax_02.jpg');" data-img-width="1627" data-img-height="868" data-diff="100">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="blog-wrapper">
                            <div class="blog-title">
                                ...
                                <h2><a href="#" title="">Best SEO Google System and Algoritmas</a></h2>
                                <div class="post-meta">
                                    <span>
                                    <i class="fa fa-user"></i>
                                    <a href="#">Jenny</a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="blog-wrapper">
                            <div class="blog-title">
                                ...
                                <h2><a href="#" title="">Never Forget! WooCommerce is an Amazing Plugin</a></h2>
                                <div class="post-meta">
                                    <span>
                                    <i class="fa fa-user"></i>
                                    <a href="#">Bob Doe</a>
                            ...
                            <div class="blog-image">
                                <a href="#" title=""><img src="../assets/upload/blog_03.jpg" alt="" class="img-responsive"></a>
                            </div><!-- end image -->
                            <div class="blog-desc">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since theown printer took.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="testimonial">
                            <img class="alignleft img-circle" src="../assets/upload/student_01.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="testimonial">
                            <img class="alignleft img-circle" src="../assets/upload/student_02.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="testimonial">
                            <img class="alignleft img-circle" src="../assets/upload/student_03.png" alt="">
        ...
        <section class="grey section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <img src="../assets/upload/client_01.png" alt="" class="img-responsive img-thumbnail">
                    </div>

                    <div class="col-md-2">
                        <img src="../assets/upload/client_02.png" alt="" class="img-responsive img-thumbnail">
                    </div>

                    <div class="col-md-2">
                        <img src="../assets/upload/client_03.png" alt="" class="img-responsive img-thumbnail">
                    </div>

                    <div class="col-md-2">
                        <img src="../assets/upload/client_04.png" alt="" class="img-responsive img-thumbnail">
                    </div>

                    <div class="col-md-2">
                        <img src="../assets/upload/client_05.png" alt="" class="img-responsive img-thumbnail">
                    </div>

                    <div class="col-md-2">
                        <img src="../assets/upload/client_06.png" alt="" class="img-responsive img-thumbnail">
                    </div>
                </div><!-- end button-wrapper -->
            </div><!-- end container -->
        </section><!-- end section -->
